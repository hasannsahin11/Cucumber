...
public class _02_CountrySteps {
    ...
    public void createANewCountry() {
        ...
        dc.sendKeysMethod(dc.getFormNameInput(),"ABD1");
        dc.sendKeysMethod(dc.getFormCodeInput(),"B0");
    ...
    public void deleteCountry() {
        dc.sendKeysMethod(dc.getNameSearch(),"ABD1");
        dc.sendKeysMethod(dc.getCodeSearch(),"B0");
